...
class IndexMgr {
   ...
   public IndexMgr(boolean isnew, TableMgr tblmgr, StatMgr statmgr, Transaction tx) {
      if (isnew) {
         ...
         sch.addStringField("structname", MAX_NAME);
    ...
    * @param structname the name of the index structure
    * @param tx the calling transaction
    */
   public void createIndex(String idxname, String tblname, String fldname, String structname, Transaction tx) {
      ...
      ts.setString("structname", structname);
      ts.close();
   }
   ...
   public Map<String,IndexInfo> getIndexInfo(String tblname, Transaction tx) {
      ...
      while (ts.next())
         ...
         String structname = ts.getString("structname");
         Layout tblLayout = tblmgr.getLayout(tblname, tx);
         StatInfo tblsi = statmgr.getStatInfo(tblname, tblLayout, tx);
         IndexInfo ii = new IndexInfo(idxname, fldname, structname, tblLayout.schema(), tx, tblsi);
